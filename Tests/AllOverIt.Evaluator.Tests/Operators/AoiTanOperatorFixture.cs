...
{
    public class AoiTanOperatorFixture : AoiFixtureBase
    {
        private readonly double _value;
        private readonly Expression _operand;
        private AoiTanOperator _operator;

        public AoiTanOperatorFixture()
        {
            _value = Create<double>();
            _operand = Expression.Constant(_value);
            _operator = new AoiTanOperator(_operand);
        }

        public class Constructor : AoiTanOperatorFixture
        {
            [Fact]
            public void Should_Throw_When_Operand_Null()
            {
                Invoking(() => _operator = new AoiTanOperator(null))
                    .Should()
        ...
        public class GetExpression : AoiTanOperatorFixture
        {
            [Fact]
