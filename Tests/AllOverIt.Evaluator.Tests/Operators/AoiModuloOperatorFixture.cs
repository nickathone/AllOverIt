...
{
    public class AoiModuloOperatorFixture : AoiFixtureBase
    {
        ...
        private AoiModuloOperator _operator;

        public AoiModuloOperatorFixture()
        {
            ...
            _operator = new AoiModuloOperator(_leftOperand, _rightOperand);
        }

        public class Constructor : AoiModuloOperatorFixture
        {
            [Fact]
            public void Should_Throw_When_Left_Operand_Null()
            {
                Invoking(() => _operator = new AoiModuloOperator(null, this.CreateStub<Expression>()))
                    .Should()
            ...
            {
                Invoking(() => _operator = new AoiModuloOperator(this.CreateStub<Expression>(), null))
                    .Should()
                    .Throw<ArgumentNullException>()
        ...
        public class GetExpression : AoiModuloOperatorFixture
        {
            [Fact]
