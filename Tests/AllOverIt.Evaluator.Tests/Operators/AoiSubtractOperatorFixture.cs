...
{
    public class AoiSubtractOperatorFixture : AoiFixtureBase
    {
        ...
        private AoiSubtractOperator _operator;

        public AoiSubtractOperatorFixture()
        {
            ...
            _operator = new AoiSubtractOperator(_leftOperand, _rightOperand);
        }

        public class Constructor : AoiSubtractOperatorFixture
        {
            [Fact]
            public void Should_Throw_When_Left_Operand_Null()
            {
                Invoking(() => _operator = new AoiSubtractOperator(null, this.CreateStub<Expression>()))
                    .Should()
            ...
            {
                Invoking(() => _operator = new AoiSubtractOperator(this.CreateStub<Expression>(), null))
                    .Should()
                    .Throw<ArgumentNullException>()
        ...
        public class GetExpression : AoiSubtractOperatorFixture
        {
            [Fact]
