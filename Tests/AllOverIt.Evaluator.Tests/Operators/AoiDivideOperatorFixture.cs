...
{
    public class AoiDivideOperatorFixture : AoiFixtureBase
    {
        ...
        private AoiDivideOperator _operator;

        public AoiDivideOperatorFixture()
        {
            ...
            _operator = new AoiDivideOperator(_leftOperand, _rightOperand);
        }

        public class Constructor
          : AoiDivideOperatorFixture
        {
            [Fact]
