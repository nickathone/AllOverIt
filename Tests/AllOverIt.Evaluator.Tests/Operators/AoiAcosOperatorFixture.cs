...
{
    public class AoiAcosOperatorFixture : AoiFixtureBase
    {
        private readonly double _value;
        private readonly Expression _operand;
        private AoiAcosOperator _operator;

        public AoiAcosOperatorFixture()
        {
            _value = Create<double>();
            _operand = Expression.Constant(_value);
            _operator = new AoiAcosOperator(_operand);
        }

        public class Constructor : AoiAcosOperatorFixture
        {
            [Fact]
            public void Should_Throw_When_Operand_Null()
            {
                Invoking(() => _operator = new AoiAcosOperator(null))
                    .Should()
        ...
        public class GetExpression : AoiAcosOperatorFixture
        {
            [Fact]
