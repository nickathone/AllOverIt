...
{
    public class AoiFormulaCompilerFixtureFunctionalPercent : AoiFormulaCompilerFixtureFunctionalBase
  {
    [Fact]
    public void Should_Calculate_Percentage_Of_Aggregated_Values()
    {
      ...
      for (var i = 0; i < 20; i++)
      {
          ...
          registry.AddVariable(new AoiConstantVariable(name1, numbers1.ElementAt(i)));

          var name2 = names2.ElementAt(i);
          registry.AddVariable(new AoiConstantVariable(name2, numbers2.ElementAt(i)));
      }
