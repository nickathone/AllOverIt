...
namespace AllOverIt.Patterns.Specification.Exceptions
{
    ...
    public sealed class LinqSpecificationVisitorException : Exception
    {
        ...
        internal LinqSpecificationVisitorException(string message, Exception innerException, string partialQueryString)
