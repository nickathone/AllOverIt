...
namespace AllOverIt.Reflection
{
    public static class ReflectionHelper
    {
        ...
        /// <returns>The property metadata, as <see cref="PropertyInfo"/>, of a specified <typeparam name="TType"/>.</returns>
        /// <remarks>When class inheritance is involved, this method returns the first property found, starting at the type represented
        /// by <typeparam name="TType"/>.</remarks>
        ...
        /// <returns>The method metadata, as <see cref="MethodInfo"/>, of a specified <typeparam name="TType"/>.</returns>
        ...
        /// <summary>
        /// Gets <see cref="MethodInfo"/> (method metadata) for a given <typeparam name="TType"/> method with a given name and no arguments.
        /// </summary>
        /// <typeparam name="TType">The type to obtain method metadata for.</typeparam>
        /// <param name="name">The name of the method.</param>
        /// <returns>The method metadata, as <see cref="MethodInfo"/>, of a specified <typeparam name="TType"/> with a given name and no arguments.</returns>
        ...
        /// <summary>
        /// Gets <see cref="MethodInfo"/> (method metadata) for a given <typeparam name="TType"/> method with a given name and argument types.
        /// </summary>
        /// <typeparam name="TType">The type to obtain method metadata for.</typeparam>
        /// <param name="name">The name of the method.</param>
        /// <param name="types">The argument types expected on the method</param>
        /// <returns>The method metadata, as <see cref="MethodInfo"/>, of a specified <typeparam name="TType"/> with a given name and argument types.</returns>
        /// <remarks>All instance, static, public, and non-public methods are searched.</remarks>
