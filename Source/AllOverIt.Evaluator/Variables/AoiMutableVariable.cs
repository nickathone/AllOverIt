...
namespace AllOverIt.Evaluator.Variables
{
    ...
    public sealed class AoiMutableVariable : AoiVariableBase, IAoiMutableVariable
    {
        ...
        public AoiMutableVariable(string name, double value = default, IEnumerable<string> referencedVariableNames = null)
