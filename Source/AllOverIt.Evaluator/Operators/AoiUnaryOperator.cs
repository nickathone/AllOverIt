...
namespace AllOverIt.Evaluator.Operators
{
    ...
    public abstract class AoiUnaryOperator : AoiOperator<Func<Expression, Expression>>
    {
        internal Expression Operand { get; set; }

        protected AoiUnaryOperator(Func<Expression, Expression> operatorType, Expression operand)
          : base(operatorType)
        {
