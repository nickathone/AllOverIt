...
namespace AllOverIt.Evaluator
{
    ...
    public interface IFormulaReader : IDisposable
    {
        ...
        string ReadNamedOperand(IArithmeticOperationFactory operationFactory);

        // Reads an operator starting at the current reader position.
        // Returns the operator symbol read.
        string ReadOperator(IArithmeticOperationFactory operationFactory);
    }
}